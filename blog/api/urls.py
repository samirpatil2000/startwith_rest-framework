...
from blog.api.views import api_view,blog_api_detail,blog_api_create,blog_api_delete,blog_api_update,BlogApiListView
...
urlpatterns = [
    ...
    path('list',BlogApiListView.as_view(),name='api-list'),
